...
export const questions: Question[] = [
  // The questions will be mapped and shuffled below
  ...[
    {
      id: 1,
      group: "group1",
    ...
    },
    {
      ...
      sinhalaQuestion: "සංඛ්‍යාතය මැනීමට භාවිතා කරන උපකරණය කුමක්ද?",
      answers: [
        "Voltmeter (වෝල්ට්මීටරය)",
        "Ammeter (ඇම්මීටරය)",
        "Frequency meter (අවෘත්තිය මීටරය)",
    ...
    },
    {
      id: 31,
      group: "group1",
      question: "What is the primary use of an oscilloscope?",
      sinhalaQuestion: "ඔසිලෝස්කෝප් එකේ ප්‍රධාන භාවිතය කුමක්ද?",
      answers: [
        "To measure voltage over time (කාලය අනුව වෝල්ටීයතාව මැනීම)",
        "To amplify signals (සංඥා වර්ධනය කිරීම)",
        "To store electrical energy (විදුලි ශක්තිය ගබඩා කිරීම)",
        "To convert AC to DC (AC DC වෙත පරිවර්තනය කිරීම)",
        "To measure current (ධාරාව මැනීම)"
    ...
    },
    {
      ...
      sinhalaQuestion: "විදුලි සංඥා වර්ධනය කිරීමට භාවිතා කරන උපකරණය කුමක්ද?",
      answers: [
        "Transistor (ට්‍රාන්සිස්ටරය)",
        "Resistor (ප්‍රතිරෝධකය)",
        "Capacitor (කැපැසිටරය)",
    ...
    },
    {
      ...
      sinhalaQuestion: "සර්කට් එකක ට්‍රාන්සිස්ටරයේ කාර්යය කුමක්ද?",
      answers: [
        "To switch or amplify signals (සංඥා නවතා හෝ වර්ධනය කිරීම)",
        "To store charge (ආරෝපණය ගබඩා කිරීම)",
        "To resist current (ධාරාවට ප්‍රතිරෝධ වීම)",
        "To convert AC to DC (AC DC වෙත පරිවර්තනය කිරීම)",
        "To measure voltage (වෝල්ටීයතාව මැනීම)"
    ...
    },
    {
      id: 34,
      group: "group4",
      question: "Which component is used to filter signals in a circuit?",
      sinhalaQuestion: "සර්කට් එකක සංඥා පෙරහනය කිරීමට භාවිතා කරන කොටස කුමක්ද?",
      answers: [
        "Capacitor (කැපැසිටරය)",
        "Resistor (ප්‍රතිරෝධකය)",
        "Inductor (ඉන්ඩක්ටරය)",
    ...
    },
    {
      ...
      sinhalaQuestion: "ADC (ඇනලොග් සිට ඩිජිටල් පරිවර්තකය) කුමක් කරයිද?",
      answers: [
        "Converts analog signals to digital (ඇනලොග් සංඥා ඩිජිටල් බවට පරිවර්තනය කරයි)",
        "Converts digital signals to analog (ඩිජිටල් සංඥා ඇනලොග් බවට පරිවර්තනය කරයි)",
        "Amplifies signals (සංඥා වර්ධනය කරයි)",
        "Stores electrical energy (විදුලි ශක්තිය ගබඩා කරයි)",
        "Measures voltage (වෝල්ටීයතාව මනියි)"
      ],
      correctAnswer: 0
    },
    {
      ...
      sinhalaQuestion: "ඩිජිටල් සංඥා ඇනලොග් බවට පරිවර්තනය කිරීමට භාවිතා කරන උපකරණය කුමක්ද?",
      answers: [
        "DAC (ඩීඒසී)",
        "ADC (ඒඩීසී)",
        "Op-amp (ඔප් ඇම්ප්)",
    ...
    },
    {
      id: 37,
      group: "group4",
      question: "What is the role of an op-amp in electronics?",
      sinhalaQuestion: "විදුලි ඉලෙක්ට්‍රොනිකයේ ඔප් ඇම්ප් එකේ භූමිකාව කුමක්ද?",
      answers: [
        "To amplify voltage signals (වෝල්ටීයතාව සංඥා වර්ධනය කිරීම)",
        "To store electrical energy (විදුලි ශක්තිය ගබඩා කිරීම)",
        "To convert AC to DC (AC DC වෙත පරිවර්තනය කිරීම)",
        "To measure current (ධාරාව මැනීම)",
        "To switch circuits (සර්කට් නවතා හෝ ඇරීම)"
      ],
      correctAnswer: 0
    },
    {
      id: 38,
      group: "group5",
      question: "Which component is used to store energy in an electric field?",
      sinhalaQuestion: "විදුලි ක්ෂේත්‍රයක ශක්තිය ගබඩා කිරීමට භාවිතා කරන කොටස කුමක්ද?",
      answers: [
        "Capacitor (කැපැසිටරය)",
        "Inductor (ඉන්ඩක්ටරය)",
        "Resistor (ප්‍රතිරෝධකය)",
    ...
    const newCorrectIndex = shuffled.findIndex(a => a === correctText);
    return {
      ...q,
      answers: shuffled,
